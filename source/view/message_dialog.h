...
class MessageWindow : public QDialog {
 ...
 public:
  explicit MessageWindow(QString const &messege, QString const &title,
                         QIcon button1, QSize size1, QIcon button2, QSize size2,
    ...
    ui->pushButton_1->setStyleSheet(StyleHelper::getUndoButtonStyle());
    ui->pushButton_1->setIcon(button1);
    ui->pushButton_1->setIconSize(size1);

    ui->pushButton_2->setStyleSheet(StyleHelper::getUndoButtonStyle());
